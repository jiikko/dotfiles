...
- **318**: 監査の記録 issue。派生（310-317）が全部片付いたら done、という条件を本文に明記した。**2026-09-09 時点で 310 / 311 / 312 / 314 / 316 / 317 が done**（318 本文に内訳あり）。318 を閉じるのに残っているのは **313 と本 issue（315）の 2 本だけ**。
  この issue もその派生の 1 つ
- **この issue自体は未着手**（順番待ち）
