...
- `issues_view_frame 0.044ms / 33.031 KB`、`issues_view_2000 0.049ms / 34.820 KB` (全て予算内)
- 確保はローカル実測 (33.03 / 34.82 KB) と一致 (差 0.01% 未満)。締め先の目安: +3% ≈ 34.1 / 35.9。
  数 run 溜まったら 34.7 / 36.6 から締める (065 の issue_scan と同じタイミングでよい)
