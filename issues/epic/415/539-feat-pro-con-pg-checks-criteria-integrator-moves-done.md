...
- 同じ issue を複数のカードが扱う (437 の続き・452 の残りのように) ときは、本文の印と進捗が取り込みで衝突しうる。文書だけの衝突は両方を残して解く (`integrator-guide.md` の役目 4 の既存の扱い)。
  done へ移すのは、その issue を扱う完了していないカードが残っていないときだけ
