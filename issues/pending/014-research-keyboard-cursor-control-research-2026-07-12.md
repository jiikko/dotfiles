...
調査日: 2026-07-12
状態: **pending** (2026-09-05 ユーザー判断)。調査は完了しており、§7 のアクションプラン (neru 試用 /
Karabiner チューニング / Keymou / OS Mouse Keys 仮説の検証) の採否が未決。
**着手条件 (trigger)**: D+モードのカーソル移動の粗さを直したくなったとき。そのとき §7 の 1 から順に試す。
