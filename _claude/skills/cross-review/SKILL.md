...
`/codex-review` スキルの SKILL.md を Read し、手順に従って `codex review` を実行する。

- commit ID 指定あり → `codex review --commit {sha} "{カスタム指示}"`
- なし → `codex review --uncommitted "{カスタム指示}"`
